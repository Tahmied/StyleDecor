                        ...
                        <div className="bg-[rgba(192,221,255,0.05)] backdrop-blur-sm border border-[rgba(192,221,255,0.15)] rounded-2xl p-8 shadow-2xl">
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className="absolute cursor-pointer right-4 top-1/2 -translate-y-1/2 text-[rgba(192,221,255,0.5)] hover:text-[#C0DDFF] transition-colors duration-300"
                                        >
                                ...
                                <p className="text-center font-urbanist text-[13px] text-[rgba(222,235,250,0.70)] pt-2">
                                    ...
                                    <Link href="/register" className="text-[#C0DDFF] hover:text-[#DEEBFA] font-semibold transition-colors duration-300">
                                        Sign Up
                                    </Link>
                                </p>
                            </div>
