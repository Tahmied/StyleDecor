            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid w-[90%] grid-cols-1 lg:max-w-full lg:w-[90%] mx-auto lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="flex flex-col">
                        ...
                        <button className="inline-flex items-center text-gray-900 font-medium text-lg hover:gap-3 transition-all group">
                            Read More
                    ...
                    <div className="flex flex-col space-y-8">
                        {articles.map((article) => (
                            <div key={article.id} className="flex flex-col border-b border-gray-200 pb-8 last:border-b-0">
                                <div className="flex flex-col sm:flex-row gap-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <button className="inline-flex items-center text-gray-600 hover:text-gray-900 font-medium hover:gap-3 transition-all group">
                                            Read More
                                            <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                            </svg>
                        ...
                        <div className="flex justify-end pt-4">
                            <button className="bg-gray-900 text-white px-8 py-4 rounded-full font-medium inline-flex items-center hover:bg-gray-800 transition-colors group">
                                View All
                                <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                </svg>
