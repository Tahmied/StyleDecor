...
const Hero = () => {
    return (
        <>
            <section className="hero h-full -mt-10">
                <div className="hero-container w-[90%] h-full mx-auto flex flex-col items-center justify-center max-w-6xl">
                    ...
                    <p className="font-urbanist font-medium text-[13px] text-center tracking-[0.03em] lowercase text-[rgba(222,235,250,0.80)] mt-0 md:text-[16px] md:mt-0 lg:text-[20px] lg:mt-0 max-w-3xl">
